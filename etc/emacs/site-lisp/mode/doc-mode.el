...
(defface doc-title-0-face
  `((((class color)
      (background dark))
     (:foreground "brown2" :bold t))
    (((class color)
      (background light))
     (:foreground "brown2" :bold t))
    (t ()))
...
(defvar doc-title-0 'doc-title-0-face)
...
(defvar general-font-lock-blue2 'doc-title-3-face)
...
(defvar general-font-lock-yellow1 'doc-title-3-face)
...
(defconst doc-font-lock-keywords
  (eval-when-compile
    (list
     ...
     ;; Delimited blocks
     (cons "^[=*_\\.]\\{4,\\} *\$" 'general-font-lock-yellow1)
     (cons "^\\.\\{4,\\} *\$"	'general-font-lock-yellow1)
     ...
     ;; Delimited blocks
     (cons "^\\[.*\\].*\$" 'general-font-lock-yellow1)
...
;; Last update Sun Oct 18 16:58:18 2009 Cedric GESTES
