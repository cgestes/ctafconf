...
-- pomme+shift+left/right => change workspace
-- pomme+left/right => change window in group
-- pomme+up/down => change group
...
for s = 1, screen.count() do
  ...
  for tagnumber, tagname in ipairs(tags_name) do
    tags[s][tagnumber] = tag({ name = tagname, layout = layouts[tags_layout[tagnumber]] })
...
keybinding({ modkey }, "F8", function() awful.util.spawn("totem") end):add()

--keybinding({ modkey, }, "x", function() awful.util.spawn("xlock") end):add()
...
keybinding({ modkey, "Shift" }, "Return", function () if client.focus then client.focus.fullscreen = not client.focus.fullscreen end end):add()

keybinding({ modkey }, "c", function () if client.focus then client.focus:kill() end end):add()
...
--keybinding({ modkey, "Shift" }, "Left", function () awful.client.focus.bydirection("left"); if client.focus then client.focus:raise() end end):add()
--keybinding({ modkey, "Shift" }, "Right", function () awful.client.focus.bydirection("right");  if client.focus then client.focus:raise() end end):add()
--keybinding({ modkey, "Shift" }, "Up", function () awful.client.focus.bydirection("up"); if client.focus then client.focus:raise() end end):add()
--keybinding({ modkey, "Shift" }, "Down", function () awful.client.focus.bydirection("down");  if client.focus then client.focus:raise() end end):add()
...
keybinding({ modkey }, "F12", function ()
...
keybinding({ modkey }, "F1", revelation.revelation):add()
