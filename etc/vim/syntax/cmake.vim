...
syn keyword cmakeStatement
      \ ADD_CUSTOM_COMMAND ADD_CUSTOM_TARGET ADD_DEFINITIONS ADD_DEPENDENCIES ADD_EXECUTABLE ADD_LIBRARY ADD_SUBDIRECTORY ADD_TEST AUX_SOURCE_DIRECTORY BUILD_COMMAND BUILD_NAME CMAKE_MINIMUM_REQUIRED CONFIGURE_FILE CREATE_TEST_SOURCELIST ELSE ELSEIF ENABLE_LANGUAGE ENABLE_TESTING ENDFOREACH ENDFUNCTION ENDIF ENDMACRO ENDWHILE EXEC_PROGRAM EXECUTE_PROCESS EXPORT_LIBRARY_DEPENDENCIES FILE FIND_FILE FIND_LIBRARY FIND_PACKAGE FIND_PATH FIND_PROGRAM FLTK_WRAP_UI FOREACH FUNCTION GET_CMAKE_PROPERTY GET_DIRECTORY_PROPERTY GET_FILENAME_COMPONENT GET_SOURCE_FILE_PROPERTY GET_TARGET_PROPERTY GET_TEST_PROPERTY IF INCLUDE INCLUDE_DIRECTORIES INCLUDE_EXTERNAL_MSPROJECT INCLUDE_REGULAR_EXPRESSION INSTALL INSTALL_FILES INSTALL_PROGRAMS INSTALL_TARGETS LINK_DIRECTORIES LINK_LIBRARIES LIST LOAD_CACHE LOAD_COMMAND MACRO MAKE_DIRECTORY MARK_AS_ADVANCED MATH MESSAGE OPTION OUTPUT_REQUIRED_FILES PROJECT QI_ADD_OPTIONAL_PACKAGE QI_ADD_SUBDIRECTORY QI_ADD_TEST QI_CREATE_BIN QI_CREATE_CONFIG_H QI_CREATE_GTEST QI_CREATE_LIB QI_CREATE_PERF_TEST QI_CREATE_PYTHON_EXT QI_CREATE_SCRIPT QI_CREATE_TEST QI_CREATE_TEST_HELPER QI_CREATE_TRAD QI_DEBUG QI_DEPRECATED QI_ERROR QI_GENERATE_HEADER QI_GENERATE_SRC QI_GENERATE_TRAMPOLINE QI_INFO QI_INSTALL QI_INSTALL_CMAKE QI_INSTALL_CONF QI_INSTALL_DATA QI_INSTALL_DOC QI_INSTALL_HEADER QI_INSTALL_LIBRARY QI_INSTALL_PROGRAM QI_INSTALL_PYTHON QI_INSTALL_TARGET QI_INSTALL_TEST_DATA QI_RUN_PY_CMD QI_RUN_PY_SCRIPT QI_SANITIZE_COMPILE_FLAGS QI_STAGE_BIN QI_STAGE_CMAKE QI_STAGE_DIR QI_STAGE_HEADER_ONLY_LIB QI_STAGE_LIB QI_STAGE_SCRIPT QI_SUBMODULE_ADD QI_SUBMODULE_CREATE QI_SWIG_WRAP_JAVA QI_SWIG_WRAP_PYTHON QI_USE_LIB QI_VERBOSE QI_WARNING QT_WRAP_CPP QT_WRAP_UI REMOVE REMOVE_DEFINITIONS SEPARATE_ARGUMENTS SET SET_DIRECTORY_PROPERTIES SET_SOURCE_FILES_PROPERTIES SET_TARGET_PROPERTIES SET_TESTS_PROPERTIES SITE_NAME SOURCE_GROUP STRING SUBDIR_DEPENDS SUBDIRS TARGET_LINK_LIBRARIES TRY_COMPILE TRY_RUN UNSET USE_MANGLED_MESA UTILITY_SOURCE VARIABLE_REQUIRES VTK_MAKE_INSTANTIATOR VTK_WRAP_JAVA VTK_WRAP_PYTHON VTK_WRAP_TCL WHILE WRITE_FILE
            \ nextgroup=cmakeArguments
